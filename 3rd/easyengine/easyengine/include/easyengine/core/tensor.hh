...
#include "easyengine/core/dtype.hh"
...
ENGINE_EXPORT DistLayout transpose_layout(DistLayout dist_layout);
ENGINE_EXPORT const char* get_dist_layout_name(DistLayout dist_layout);

ENGINE_EXPORT size_t get_elem_size(DataType dtype);
ENGINE_EXPORT size_t get_numel(std::initializer_list<size_t> size);
ENGINE_EXPORT size_t get_numel(const std::vector<size_t>& size);
ENGINE_EXPORT void check_no_zero(const std::vector<size_t>& size);

class TensorImpl;
class Tensor;
class ENGINE_EXPORT Tensor {
public:
...
public:
    ...
    /**************************** IO functions ****************************/
    ENGINE_EXPORT friend std::ostream& operator<<(std::ostream& os, const Tensor& tensor);
